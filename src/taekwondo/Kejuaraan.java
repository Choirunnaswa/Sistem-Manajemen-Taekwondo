 ...
 */
public class Kejuaraan extends javax.swing.JFrame {
    ...
    private void simpan() {
        try {
            ...
            String sql = "INSERT INTO juara (kode, nama, tgl,jumlah, keterangan) VALUES ('"
...
public void savePanelAsImage(JPanel panel, String filePath) {
    ...
    private void load_data()
    {
        ...
        String sql_data="SELECT * FROM juara";
        try
        {
            Statement st=kon.createStatement();
    ...
    try {
        ...
        if (kodeTerpilih != null && !kodeTerpilih.isEmpty()) {
            String sql_update = "UPDATE juara SET "
...
private void hapus() {
    try {
        Connection kon = koneksi.koneksiDb();
        String sql = "DELETE FROM juara WHERE kode='" + kodeTerpilih + "'";
    ...
    private void TampilData(){
        try{
            ...
            rs = st.executeQuery("SELECT * FROM juara");
        ...
        try
    {
        Connection kon=koneksi.koneksiDb();
        Statement st=kon.createStatement();
        String sql="INSERT INTO juara VALUES('"+KodeAnggota.getSelectedItem()
                +"','"+NamaAnggota.getText()
                +"','"+Tgl.getText()
                  +"','"+Jumlah.getText()
                +"','"+Keterangan.getText()
...
private void cetakStruk() {
    ...
    // Judul Struk
    JLabel judul = new JLabel("====== STRUK PEMBAYARAN KEJUARAAN ======");
...
private void isiKodeAnggota() {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("PEMBAYARAN KEJUARAAN TAEKWONDO ESPA");
    ...
    private void SimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SimpanActionPerformed
        ...
        try {
            ...
            if (isUpdate) {
                // MODE UPDATE
                String sql = "UPDATE juara SET nama = '" + NamaAnggota.getText() +
                "', tgl = '" + Tgl.getText() +
                "', jumlah = '" + Jumlah.getText() +
                "', keterangan = '" + Keterangan.getText() +
                ...
                // MODE SIMPAN BARU
                String cek = "SELECT * FROM juara WHERE kode = '" + KodeAnggota.getSelectedItem() + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kejuaraan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
